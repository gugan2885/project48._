...
var fruits,orangeImg,melonImg,cherryImg,appleImg;
...
function preload()
{
  ...
  cherryImg=loadImage("images/cherry-removebg-preview.png");
  orangeImg=loadImage("images/orange-removebg-preview.png");
  appleImg=loadImage("images/apple-removebg-preview.png");
...
function draw() 
{
 ...
 // text("Thank You For Playing this Game",)
  ...
  control.visible=false;
  fill("red");
  text("STORY: one day  two rabbits from the forest came to the city.",30,100);
  fill("orange");
  text("  into a warehouse, in search of food they saw some carrots",30,200);
  fill("yellow");
  text("but they accidently stepped into a button. Suddenly ",10,300);
  fill("green");
  text("a rocket appeared.Sudennly the rocket took them to space ",10,400);
  fill("blue")
  text("Now in order to get back to Earth They have to",30,500);
  fill("indigo")
  text("collect stars and feed the bunny",30,600);
  fill("violet")
  text(" to get back to earth",30,700);
  fill("red")
